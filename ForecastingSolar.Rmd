...
```{r fig.height=4, fig.width=8, message=FALSE, warning=FALSE, include=FALSE}
...
solarwindplot + ggthemes::theme_tufte()
```
...
#forecast
holdforc <- sarima.for(logsolarholdout, n.ahead = 13, p =0, d = 1, q = 1,  P = 1, 
                   D = 1, Q = 1, S = 12)
...
forecast5plot <- ggplot(data = forc5df) + 
  ...
  geom_ribbon(aes(x = date, ymin=LL, ymax=UL, fill = "89% conf."), alpha=0.75) +
